...
\section{Experiments}
    ...
    TODO: Say something like "The purpose of this section is two-fold: ???, and to demonstrate the superiority of linearithmic all-mixing operations to quadratic ones on simple data."
    ...
    TODO: Compare with GAN-augmented RNNs.

    TODO: Run GAN-augmented RNNs with no inputs. Hopefully, it won't be completely indistinguishable from random noise.
